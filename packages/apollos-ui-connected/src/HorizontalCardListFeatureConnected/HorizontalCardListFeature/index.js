...
const HorizontalCardListFeature = memo((props) => {
  const {
    isLoading,
    cards,
    subtitle,
        ...
        {isLoading || title || subtitle || primaryAction ? (
          <Header>
            ...
            {isLoading || primaryAction ? (
              <AndroidTouchableFix onPress={() => onPressAction(primaryAction)}>
                <ButtonLinkSpacing>
                  <H6>
...
HorizontalCardListFeature.displayName = 'VerticalCardListFeature';
