...
import RecentlyLikedContentFeed from './RecentlyLikedContentFeed';

describe('RecentlyLikedContentFeed component', () => {
  it('renders RecentlyLikedContentFeed', async () => {
    const mock = {
      request: {
    ...
    const tree = renderer.create(
      <Providers mocks={[mock]}>
        <RecentlyLikedContentFeed navigation={navigation} />
      </Providers>
    );
