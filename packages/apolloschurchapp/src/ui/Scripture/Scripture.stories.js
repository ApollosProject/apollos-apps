...
stories.add('Genesis 1:1-5', () => (
  <ScrollView>
    <PaddedView>
      <Item
        reference={genesis1.reference}
        content={genesis1.content}
        isLoading={false}
      />
    </PaddedView>
  </ScrollView>
...
stories.add('Psalm 23', () => (
  <ScrollView>
    <PaddedView>
      <Item
        reference={psalm23.reference}
        content={psalm23.content}
        isLoading={false}
      />
    </PaddedView>
  </ScrollView>
...
stories.add('Revelation 22:20-21', () => (
  <ScrollView>
    <PaddedView>
      <Item
        reference={revelation22.reference}
        content={revelation22.content}
        isLoading={false}
      />
    </PaddedView>
  </ScrollView>
